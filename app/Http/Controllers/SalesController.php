...
class SalesController extends Controller
{
    ...
    {
        $sales = SalesModel::select('penjualan_id', 'user_id', 'pembeli', 'penjualan_kode', 'tanggal')->with('user');
    ...
    public function show(string $id)
    {
        ...
        return view('sales.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'activeMenu' => $activeMenu, 'sales' => $sales]);
    }
